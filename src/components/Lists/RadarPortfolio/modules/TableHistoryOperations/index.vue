<template>
  <div class="tableHistory">
    <div class="tableHistory__container">
      <ListHeaderPortfolioHistoryOperations class="tableHistory__header" />
      <ScrollArea>
        <table class="tableHistory__table">
          ...
          <tbody>
            <tr v-for="(item, index) in tableItems" :key="index">
              ...
              <td>{{ item.price }}</td>
              <td>
                <div class="tableHistory__tdRow">
                  <div class="tableHistory__tdSum">{{ item.sum }}</div>
                  <div class="tableHistory__tdActions">
                    <img alt="Edit" class="tableHistory__tdAction" :src="iconEdit" />
                    <img alt="Delete" class="tableHistory__tdAction" :src="iconTrash" />
                  </div>
                </div>
              </td>
            </tr>
...
export default defineComponent({
  name: 'ListActivesRadarPortfolioTableHistoryOperations',
  components: {
