...
import { candleChart } from '@/views/TechnicalAnalysis/modules/Body/modules/Chart/settings/candle';
import { useTechAnalysisStore } from '@/store/pinia/technicalAnalysis';

const techStore = useTechAnalysisStore();
const { _catch } = useError('TechAnCandleChart');
...
watch(
  ...
  () => {
    if (techStore.selectedChartMode === 'candle') {
      chart.initSeries();
    }
  },
);
