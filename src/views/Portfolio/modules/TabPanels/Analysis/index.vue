<template>
  <div class="portfolioTab">
    <div class="portfolioTab__container">
      ...
      <PagePortfolioGeneralStructure />
      <PagePortfolioAssetValuation />
    </div>
    <PagePortfolioGeneralSummary />
  </div>
</template>
...
import PagePortfolioGeneralStructure from '@/views/Portfolio/modules/GeneralStructure/index.vue';
import PagePortfolioGeneralSummary from '@/views/Portfolio/modules/GeneralSummary/index.vue';
import PagePortfolioAssetValuation from '@/views/Portfolio/modules/AssetValuation/index.vue';

export default defineComponent({
  name: 'PagePortfolioTabAnalysis',
  components: {
    PagePortfolioAssetValuation,
    PagePortfolioGeneralSummary,
    PagePortfolioGeneralStructure,
