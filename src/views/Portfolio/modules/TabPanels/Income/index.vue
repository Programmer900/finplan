<template>
  <div class="portfolioTab">
    ...
    <ListActivesRadarPortfolioTableIncome :table-titles="tableTitles" :table-items="tableItems" />
  </div>
</template>
...
import ListActivesRadarPortfolioTableHistoryOperations from '@/components/Lists/RadarPortfolio/modules/TableHistoryOperations/index.vue';
import ListActivesRadarPortfolioTableIncome from '@/components/Lists/RadarPortfolio/modules/TableIcome/index.vue';

export default defineComponent({
  name: 'PagePortfolioTabHistory',
  components: {
    ListActivesRadarPortfolioTableIncome,
    ListActivesRadarPortfolioTableHistoryOperations,
    PagePortfolioActions,
    InputDropdown,
    PageRadarChart,
  },
  setup() {
    ...
    const tableItems = ref<any[]>([
      {
        title: 'MMC-22',
        subtitle: 'MMC Finance DAC',
        accrualDate: '08.11.2020',
        revenuePerUnit: '15.17',
        quantity: '120',
        sum: '84040.65',
      },
      {
